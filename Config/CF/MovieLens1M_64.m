dataset = 'MovieLens1M';  % num_rows, num_cols, Xtrain, ytrain, Xtest, ytest
model_radius = 2e4;
model_lambda = 1e-3;
...
% P_MOLES
eta_coef_P_MOLES = 1e4;
eta_exp_P_MOLES = 0;
lambda_P_MOLES = 1e7;
gamma_coef_P_MOLES = 1e-1;

% PD_MOLES
eta_coef_PD_MOLES = 1e4;
eta_exp_PD_MOLES = 0;
lambda_PD_MOLES = 1e7;
