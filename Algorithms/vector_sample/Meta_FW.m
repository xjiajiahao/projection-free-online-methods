function [solution, obj_values] = Meta_FW(W1, sample_fn, num_iters, sub_batch_size, eta_coef, eta_exp, rho_coef, rho_exp, reg_coef, loss_fn, grad_fn, lmo_fn, gap_fn, print_freq, IS_ADVERSARIAL, IS_CALCULATING_REGRET, optimal_solution, beta0, grad_smoothed_reg_fn, IS_SPARSE)
    if nargin < 20
        IS_SPARSE = false;
    end
