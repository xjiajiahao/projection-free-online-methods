function [solution, obj_values] = Meta_OFWRG(W1, sample_fn, num_iters, sub_batch_size, eta_coef, eta_exp, rho_coef, rho_exp, reg_coef, loss_fn, grad_fn, lmo_fn, gap_fn, print_freq, IS_ADVERSARIAL, IS_CALCULATING_REGRET, optimal_solution, beta0, grad_smoothed_reg_fn, grad_diff_fn)
    ...
    for t = 1 : num_iters
        ...
        for k = 1 : num_oracles
            % eta = min(eta_coef / k^eta_exp, 1.0);
            ...
            if k == 1
                ...
                grad_diff = grad_diff_fn(W, curr_samples, W_old, rho);
